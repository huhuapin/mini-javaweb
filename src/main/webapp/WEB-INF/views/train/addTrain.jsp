...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <form action="${ctx}/train/add" id="deptForm" method="post">
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		<tr>
		    			<td class="font3 fftd">车辆号：&nbsp;<input type="text" name="trainNumber" id="number" size="20"/></td>
					...
					<tr>
						<td class="font3 fftd" colspan="2">途径地点：<input type="text" name="site" id="site" size="55"/></td>
					</tr>
					<tr><td class="main_tdbor"></td><td class="main_tdbor"></td></tr>
					<tr>
						<td class="font3 fftd">车厢数量：<input type="text" name="carriageNum" id="carriage_num" size="20"/></td>
						<td class="font3 fftd">最大承重：<input type="text" name="bearing" id="bearing" size="20"/></td>
					</tr>
					<tr>
						<td class="font3 fftd">投产日期：<input cssClass="Wdate" autocomplete="off" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'});"
														  name="createdTime" id="created_time" size="20"/></td>
					</tr>
				</table>
		    </td></tr>
